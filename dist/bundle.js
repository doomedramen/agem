...
var _Platform = __webpack_require__(/*! ../sprites/Platform */ 127);

var _Platform2 = _interopRequireDefault(_Platform);

var _Gems = __webpack_require__(/*! ../sprites/gems/Gems */ 132);
...
var _class = function (_Phaser$State) {
    ...
    _createClass(_class, [{
        ...
        value: function create() {
            ...
            var bmd = game.add.bitmapData(this.scale.width, bgHeight);
            ...
            var dropGem = function dropGem() {
                ...
                var randomGemType = _Gems2.default.RandomGem();
...
var _Boot = __webpack_require__(/*! ./states/Boot */ 133);
...
var _Game = __webpack_require__(/*! ./states/Game */ 91);
...
var _class = function (_Phaser$Sprite) {
    ...
    function _class(game, x, y) {
        ...
        var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, x, y, 'gem-null'));
...
var _Gem = __webpack_require__(/*! ./gems/Gem */ 46);

var _Gem2 = _interopRequireDefault(_Gem);

var _Attractor = __webpack_require__(/*! ./Attractor */ 125);

var _Attractor2 = _interopRequireDefault(_Attractor);

var _NullGem = __webpack_require__(/*! ./NullGem */ 126);

var _NullGem2 = _interopRequireDefault(_NullGem);
...
var _class = function (_Phaser$Sprite) {
    ...
    function _class(game) {
        ...
        for (var i = 1; i < _this.maxGemRowSize + 1; i++) {
            // let gemSet = [];
            var gemSet = new _phaser2.default.Group(_this.game);
            for (var ii = 0; ii < i; ii++) {
                // gemSet.push(null);
                gemSet.add(new _NullGem2.default(game, 0, 0), true);
    ...
    _createClass(_class, [{
        ...
        value: function checkCollision(gem) {
            ...
            this.gemRows.map(function (gemRow, i) {
                if (!collision) {
                    var ii = -1;
                    gemRow.forEachAlive(function (attractor) {
                        ii++;
                        if (!collision) {
                            if (attractor instanceof _Attractor2.default) {
                                ...
                                if (_phaser2.default.Rectangle.intersects(_this2.scaleBounds(boundsA, 0.5), _this2.scaleBounds(boundsB, 0.5))) {
                                    collision = true;
                                    _this2.insertExistingGem(gem, i, ii);
                                }
                            }
                        }
                    });
        ...
        key: 'cleanupDeadGems',
        value: function cleanupDeadGems() {
            this.gemRows.map(function (gr) {
                console.log('removing dead gem');
                gr.forEachDead(function (dead) {
                    dead.destroy();
                });
            });
        }
        ...
        key: 'insertExistingGem',
        value: function insertExistingGem(gem, i, ii) {
            console.log('inserting existing');
            var oldGem = this.gemRows[i].getAt(ii);
            if (oldGem) {
        ...
        value: function checkIfFull() {
            var full = true;
            this.gemRows.map(function (gemRow, i) {
                gemRow.forEachAlive(function (gem) {
        ...
        value: function moveGem(y, x, yy, xx) {
            ...
            var from = this.gemRows[y].getAt(x);
            var to = this.gemRows[yy].getAt(xx);

            console.log('making new', from.constructor);

            var old1 = this.gemRows[yy].replace(to, new from.constructor(this.game, 0, 0));
            var old2 = this.gemRows[yy].replace(from, new _NullGem2.default(this.game, 0, 0));
        ...
        value: function checkGemGravity() {
            ...
            var _loop = function _loop(i) {
                ...
                gemRow.forEachAlive(function (gem) {
                    ...
                    if (gem instanceof _Gem2.default) {
                        ...
                        if (_this3.gemRows[i + 1]) {

                            //check below left //todo not working
                            var bl = undefined;
                            if (ii >= 0 && ii <= gemRow.length - 1) {
                                bl = _this3.gemRows[i + 1].getAt(ii);
                            }

                            //check below right //todo working
                            var br = undefined;
                            if (ii >= 0 && ii <= gemRow.length - 1) {
                                br = _this3.gemRows[i + 1].getAt(ii + 1);
                            }

                            var bottomLeftIsClear = bl instanceof _NullGem2.default || bl instanceof _Attractor2.default;
                            var bottomRightIsClear = br instanceof _NullGem2.default || br instanceof _Attractor2.default;
                            ...
                            if (bottomLeftIsClear && bottomRightIsClear) {
                                ...
                                if (rand === 1) {
                                    ...
                                    _this3.moveGem(i, ii, i + 1, ii);
                                } else {
                                    //go right
                                    console.log(i + ', ' + ii + ' can go right to ' + (i + 1) + ',' + (ii + 1) + ' a');
                                    _this3.moveGem(i, ii, i + 1, ii + 1);
                                }
            ...
            for (var i = this.gemRows.length - 1; i >= 0; i--) {
                _loop(i);
            }
        ...
        key: '_isEquivalent',
        value: function _isEquivalent(a, b) {
        ...
        value: function checkMatch() {
            ...
            this.gemRows.map(function (gemRow, i) {
                ...
                gemRow.forEachAlive(function (gem) {
                    ...
                    if (gem instanceof _Gem2.default) {
                        var _checkGemSiblings = function _checkGemSiblings(y, x) {
                            ...
                            toCheck.map(function (tc) {
                                ...
                                if (self.gemRows[tc.y]) {
                                    var gemToTest = self.gemRows[tc.y].getAt(tc.x);
                                    if (gemToTest) {
                                        //not null

                                        var filterdToDelete = toDelete.filter(function (t) {
                                            return t.x === tc.x && t.y === tc.y;
                                        });
                                        var filterdTested = touchingLocal.filter(function (t) {
                                            return t.x === tc.x && t.y === tc.y;
                                        });
                                        ...
                                        if (filterdToDelete.length === 0) {
                                            if (filterdTested.length === 0) {
                                                ...
                                                if (gemToTest instanceof _Gem2.default) {
                                                    //is a gem
                                                    if (gemToTest.key === gem.key) {
                                                        //same type of gem
                                                        // console.log('touching');
                                                        touchingLocal.push({ y: tc.y, x: tc.x });
                                                        _checkGemSiblings(tc.y, tc.x);
                                                    }
                                                }
                                            }
                                        }
                        ...
                        _checkGemSiblings(i, ii); //kick it off
        ...
        key: 'addGemExplosion',
        value: function addGemExplosion(gem) {
            var killerEmitter = game.add.emitter(gem.x, gem.y, 100);
        ...
        key: 'flyGemToScore',
        value: function flyGemToScore(gem) {
            return game.add.tween(gem).to({ y: 0, x: game.world.centerX }, 1000, _phaser2.default.Easing.Linear.None, true);
        }
    }, {
        ...
        value: function destroyGemsByPositions(positions) {
            ...
            positions.map(function (g) {
                ...
                var gem = _this4.gemRows[g.y].getAt(g.x);
                // console.log('destroying', g, gem.key);


                _this4.gemRows[g.y].replace(gem, new _NullGem2.default(_this4.game, 0, 0));
            ...
            this.gemRows.map(function (gemRow, i) {
                ...
                gemRow.forEachAlive(function (gem) {
                    ...
                    if (!(gem instanceof _Gem2.default)) {
                        ...
                        if (gem instanceof _NullGem2.default) {
                            //its null

                            //check the 2 under
                            if (_this5.gemRows[i + 1]) {
                                //row under exists (not bottom row)
                                if (_this5.gemRows[i + 1].getAt(ii) instanceof _Gem2.default && _this5.gemRows[i + 1].getAt(ii + 1) instanceof _Gem2.default) {
                                    _this5.gemRows[i].replace(gem, new _Attractor2.default(_this5.game, 200, 200));
                                } else {
                                    //reset it
                                    _this5.gemRows[i].replace(gem, new _NullGem2.default(_this5.game, 200, 200));
                                }
                            } else {
                                _this5.gemRows[i].replace(gem, new _Attractor2.default(_this5.game, 200, 200));
                            }
        ...
        key: 'updateGemPositions',
        value: function updateGemPositions() {
            var _this6 = this;
...
var _Gem2 = __webpack_require__(/*! ./Gem */ 46);
...
/* all exports used */
/*!****************************************!*\
  !*** ./src/sprites/gems/GemMagenta.js ***!
  \****************************************/
/***/ (function(module, exports, __webpack_require__) {
...
var _GemBlue = __webpack_require__(/*! ./GemBlue */ 128);

var _GemBlue2 = _interopRequireDefault(_GemBlue);

var _GemMagenta = __webpack_require__(/*! ./GemMagenta */ 130);

var _GemMagenta2 = _interopRequireDefault(_GemMagenta);

var _GemGreen = __webpack_require__(/*! ./GemGreen */ 129);

var _GemGreen2 = _interopRequireDefault(_GemGreen);

var _GemOrange = __webpack_require__(/*! ./GemOrange */ 131);
...
var _class = function () {
    ...
    _createClass(_class, null, [{
        ...
        key: 'RandomGem',
        value: function RandomGem() {
            // const gemList = [GemOrange, GemBlue, GemMagenta, GemGreen];
            var gemList = [_GemOrange2.default, _GemBlue2.default];
            return gemList[Math.floor(Math.random() * gemList.length)];
        }
    }, {
        key: 'DEBUG_GEM',
        value: function DEBUG_GEM() {
            return _GemBlue2.default;
        }
    }]);
...
var _Game = __webpack_require__(/*! ./Game */ 91);
...
var _class = function (_Phaser$State) {
    ...
    _createClass(_class, [{
        ...
        value: function create() {
            ...
            this.logo.scale.set(this.scale.width / _Game2.default.getScaler() * 1);
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(/*! ./_hide */ 12)(proto, TO_PRIMITIVE, __webpack_require__(/*! ./_date-to-primitive */ 138));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../webpack/buildin/global.js */ 50), __webpack_require__(/*! ./../process/browser.js */ 121)))
...
module.exports = __webpack_require__(/*! /Users/pagem/Documents/workspace/agem/src/main.js */122);
