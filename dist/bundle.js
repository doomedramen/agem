...
var _class = function (_Phaser$Sprite) {
    ...
    function _class(_ref) {
        ...
        var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, x, y, 'gem'));
...
var _Boot = __webpack_require__(/*! ./states/Boot */ 125);
...
var _class = function (_Phaser$Sprite) {
    ...
    function _class(_ref) {
        ...
        for (var i = 1; i < _this.maxGemRowSize + 1; i++) {
            ...
            for (var ii = 0; ii < i; ii++) {
                ...
                var gem = new _Gem2.default({ game: game, x: 200, y: 200 });
                _this.game.add.existing(gem);
                gemSet.push(gem);
            }
            _this.gems.push(gemSet);
        }
    ...
    _createClass(_class, [{
        ...
        value: function update() {
            ...
            var ym = 50;
            this.gems.slice(0).reverse().map(function (gemRow, i) {
                gemRow.map(function (gem, ii) {

                    var startX = _this2.x - _this2.width / 2;
                    var marginLeft = (_this2.maxGemRowSize - gemRow.length) * (gem.width / 2);
                    var x = startX + marginLeft + ii * gem.width;
                    var startY = _this2.y - _this2.height / 2;
                    var y = startY - _this2.height / 2 - gem.height / 2 * i;
...
var _Platform = __webpack_require__(/*! ../sprites/Platform */ 124);
